...
| C35 | exact ANI Go module path support | ordinary, path-collision, template-identity, layout-identity, and Todo-like legal names generated and independently verified | pass |
